    ...
    <div className="min-h-screen bg-white p-10">
      ...
      {bookmarkedCourses.length === 0 ? (
        <p className="text-gray-500">
          Belum ada course yang di-bookmark.
        </p>
      ) : (
            ...
            <Link key={course.id} to={`/courses/${course.id}`}>
              ...
              <div className="
                ...
                <div className="
                  absolute inset-0 
                  bg-gradient-to-r 
                  from-purple-300/10 via-transparent to-indigo-300/10 
                  opacity-0 group-hover:opacity-100 
                  transition duration-500">
                </div>

                <h2 className="
                  relative text-xl font-extrabold text-transparent 
                  bg-clip-text 
                  bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-500 
                ...
                <div className="
                  relative mt-6 inline-block px-5 py-2 rounded-full 
                  bg-gradient-to-r from-purple-600 to-indigo-600 
                  text-white text-xs font-semibold shadow-md 
                  group-hover:shadow-purple-400/50 
